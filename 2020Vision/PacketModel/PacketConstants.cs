...
namespace Vision2020
{
    ...
    public static class Constants
    {
        ...
        public static List<StockInfo> TeamList = new List<StockInfo>()
        {
            ...
            new StockInfo() {id=70, name="Art GP ‘20"},
            new StockInfo() {id=71, name="Campos ‘20"},
            new StockInfo() {id=72, name="Carlin ‘20"},
            new StockInfo() {id=73, name="Charouz ‘20"},
            new StockInfo() {id=74, name="Dams ‘20"},
            new StockInfo() {id=75, name="Uni-Virtuosi ‘20"},
            new StockInfo() {id=76, name="MP Motorsport ‘20" },
            new StockInfo() {id=77, name="Prema ‘20"},
            new StockInfo() {id=78, name="Trident ‘20"},
            new StockInfo() {id=79, name="BWT ‘20"},
            new StockInfo() {id=80, name="Hitech ‘20"},
            new StockInfo() {id=85, name="Mercedes 2020"},
            new StockInfo() {id=86, name="Ferrari 2020"},
            new StockInfo() {id=87, name="Red Bull 2020"},
            new StockInfo() {id=88, name="Williams 2020"},
            new StockInfo() {id=89, name="Racing Point 2020"},
            new StockInfo() {id=90, name="Renault 2020"},
            new StockInfo() {id=91, name="Alpha Tauri 2020"},
            new StockInfo() {id=92, name="Haas 2020"},
            new StockInfo() {id=93, name="McLaren 2020"},
            new StockInfo() {id=94, name="Alfa Romeo 2020"},
        ...
        public static List<StockInfo> CountryList = new List<StockInfo>()
        {
            ...
            new StockInfo() {id=16, name="Colombian"},
            new StockInfo() {id=17, name="Costa Rican", _shortName = "CR"},
            new StockInfo() {id=18, name="Croatian"},
            new StockInfo() {id=19, name="Cypriot"},
            new StockInfo() {id=20, name="Czech"},
            new StockInfo() {id=21, name="Danish"},
            new StockInfo() {id=22, name="Dutch",_shortName = "NL"},
            ...
            new StockInfo() {id=54, name="New Zealander", _shortName = "NZ"},
            new StockInfo() {id=55, name="Nicaraguan"},
            new StockInfo() {id=56, name="Northern Irish", _shortName = "NIR"},
            new StockInfo() {id=57, name="Norwegian"},
            new StockInfo() {id=58, name="Omani"},
            new StockInfo() {id=59, name="Pakistani"},
            new StockInfo() {id=60, name="Panamanian"},
            new StockInfo() {id=61, name="Paraguayan"},
            new StockInfo() {id=62, name="Peruvian"},
            new StockInfo() {id=63, name="Polish"},
            new StockInfo() {id=64, name="Portuguese"},
            new StockInfo() {id=65, name="Qatari"},
            new StockInfo() {id=66, name="Romanian"},
            new StockInfo() {id=67, name="Russian"},
            new StockInfo() {id=68, name="Salvadoran"},
            new StockInfo() {id=69, name="Saudi"},
            new StockInfo() {id=70, name="Scottish"},
            new StockInfo() {id=71, name="Serbian"},
            new StockInfo() {id=72, name="Singaporean"},
            new StockInfo() {id=73, name="Slovakian"},
            new StockInfo() {id=74, name="Slovenian"},
            new StockInfo() {id=75, name="South Korean", _shortName = "KOR"},
            new StockInfo() {id=76, name="South African", _shortName = "SAF"},
            new StockInfo() {id=77, name="Spanish"},
            new StockInfo() {id=78, name="Swedish"},
            new StockInfo() {id=79, name="Swiss", _shortName = "CH"},
            new StockInfo() {id=80, name="Thai"},
            new StockInfo() {id=81, name="Turkish"},
            new StockInfo() {id=82, name="Uruguayan"},
            new StockInfo() {id=83, name="Ukrainian"},
            new StockInfo() {id=84, name="Venezuelan", _shortName = "VZ"},
        ...
        public static List<StockInfo> DriverList = new List<StockInfo>()
        {
            ...
            new StockInfo() {id=90, name="Michael Schumacher" },
            new StockInfo() {id=91, name="Dan Ticktum" },
            new StockInfo() {id=92, name="Marcus Armstrong" },
            new StockInfo() {id=93, name="Christian Lundgaard" },
            new StockInfo() {id=94, name="Yuki Tsunoda" },
            new StockInfo() {id=95, name="Jehan Daruvala" },
            new StockInfo() {id=96, name="Gulherme Samaia" },
            new StockInfo() {id=97, name="Pedro Piquet" },
            new StockInfo() {id=98, name="Felipe Drugovich" },
            new StockInfo() {id=99, name="Robert Schwartzman" },
            new StockInfo() {id=100, name="Roy Nissany" },
            new StockInfo() {id=101, name="Marino Sato" },
            new StockInfo() {id=102, name="Aidan Jackson" },
            new StockInfo() {id=103, name="Casper Akkerman" },
            new StockInfo() {id=104, name="Casper Akkerman" },
            new StockInfo() {id=105, name="Casper Akkerman" },
            new StockInfo() {id=106, name="Casper Akkerman" },
            new StockInfo() {id=107, name="Casper Akkerman" },
            new StockInfo() {id=109, name="Jenson Button" },
            new StockInfo() {id=110, name="David Coulthard" },
            new StockInfo() {id=111, name="Nico Rosberg" }
        };
        ...
        public static List<StockInfo> TrackList = new List<StockInfo>()
        {
            ...
            new StockInfo() {id=27, name="Imola"},
            new StockInfo() {id=28, name="Portimao"},
            new StockInfo() {id=29, name="Jeddah"},
            new StockInfo() {id=30, name="?"},
            new StockInfo() {id=31, name="?"},
        ...
        public enum ButtonFlags 
        {
            ...
            D_padLeft = 0x00000010,
            D_padRight = 0x00000020,
            D_padUp = 0x00000040,
            D_padDown = 0x00000080,
